...
class SankeGamePage extends StatefulWidget {
  const SankeGamePage({super.key});

  @override
  State<SankeGamePage> createState() => _SankeGamePageState();
}
enum Direction{
  up,down,left,right
}

class _SankeGamePageState extends State<SankeGamePage> {
  ...
  void showGameOverDialog(){
    showDialog(context: context,barrierDismissible: false, builder: (context){
      return AlertDialog(
        ...
        content: const Text("You snake collided!"),
        actions: [
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          }, icon: const Icon(Icons.arrow_circle_down_outlined),iconSize:100 ,
          ),
        ],
      ),
    );
